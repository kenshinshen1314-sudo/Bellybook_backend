...
__decorate([
    ...
    (0, cache_interceptor_1.Cache)(cache_interceptor_1.CacheTTL.DAY),
...
__decorate([
    ...
    (0, cache_interceptor_1.Cache)(cache_interceptor_1.CacheTTL.FIFTEEN_MINUTES),
...
__decorate([
    ...
    (0, cache_interceptor_1.Cache)(cache_interceptor_1.CacheTTL.HALF_HOUR),
    __param(0, (0, current_user_decorator_1.CurrentUser)('userId')),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: '获取成功',
        type: cuisine_response_dto_1.CuisineDetailStatsDto,
    }),
    (0, swagger_1.ApiResponse)({
        status: 404,
        description: '菜系不存在',
    ...
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], CuisinesController.prototype, "getCuisineStats", null);
